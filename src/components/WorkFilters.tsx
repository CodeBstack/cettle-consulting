...
export function WorkFilters({ active }: { active?: WorkCategory }) {
  ...
  return (
    <div className="-mx-4 flex items-center justify-start gap-3 overflow-x-auto px-4 pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:mx-0 md:flex-wrap md:justify-center md:overflow-visible md:px-0">
